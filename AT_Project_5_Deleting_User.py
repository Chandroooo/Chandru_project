...
class OrangeHrm:
    ...
    def account_deletion(self):
        ...
        self.username = "Jacqueline.White"
        username_webelement.send_keys(self.username)
        sleep(6)
        ...
        delete_button = '//*[@class="oxd-icon bi-trash"]'
        delete_button_webelement = self.driver.find_element(By.XPATH, delete_button)
        delete_button_webelement.click()
        sleep(3)

        confirm_delete_button = '//*[@class="oxd-button oxd-button--medium oxd-button--label-danger orangehrm-button-margin"]'
        confirm_delete_button_webelement = self.driver.find_element(By.XPATH, confirm_delete_button)
        confirm_delete_button_webelement.click()
        sleep(3)
